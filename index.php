    ...
    <body>
        ...
        <div class="all">
            <div class="body">
                ...
                <p>
                    <marquee direction="left"><b class="one">Pata bidhaa mpyaa!!!</b></marquee>
                </p>               
            </div>
            <div class="mpya">
                <div class="videos">
                ...
                <div class="instructions">
                    Kupata maelekezo ya jinsi ya kutumia tovuti hii, bonyeza hapa: <b><i><a href="blog.html">Maelekezo</a></i></b>
                </div>
            </div>
        </div>
        <div class="footer">
