...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>VILEMBA EMPIRE-Order</title>
        ...
        <body>
                ...
                <div class="drp">
                    <center>
                        <ul class="dropdown">
                            ...
                            <li><button><a href="blog2.html">Our blog</a></button></li>
                            <li><button><a href="about_us2.html">About us</a></button></li>
                            <li><button><a href="contact.php">Contacts</a></button></li>
                            <li><button><a href="more2.php">Order</a></button></li>
            ...
            <div class="products">
                ...
                <div class="bidhaa">
                    <h3><b>If you want any product we have ever created, choose on here!</b></h3>
                </div>
                <div class="mpya">
                    <div class="table">
                        <?php
